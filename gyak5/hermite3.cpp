...
Matrix initPoints() {
    Matrix points;
    points.push_back ( vec2 ( 100,200 ) );
    points.push_back ( vec2 ( 200,250 ) );
...
void calculator ( vec2 t, vec3 tPoints, Matrix points ) {
    mat24 G = mat24 ( 0 );
